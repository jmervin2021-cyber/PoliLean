...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#070B19] flex flex-col justify-between text-[#F8F9FA] selection:bg-[#3A86EF] selection:text-white">
      {/* Header */}
      <header className="py-4 px-6 md:px-12 border-b border-slate-800/60 bg-[#0B132B]/60 backdrop-blur-md flex items-center justify-between sticky top-0 z-50">
      ...
      {/* Main Hero Container */}
      <div className="flex-grow flex items-center justify-center p-6 md:p-8 w-full">
        {screen === 'welcome' && (
          <div className="max-w-xl w-full mx-auto text-center space-y-8 py-6 flex flex-col items-center">
            
            {/* Seamless Logo Fade Showcase */}
            <div className="relative inline-block group">
              <div className="absolute inset-0 bg-gradient-to-r from-[#3A86EF]/20 via-[#E9C46A]/20 to-[#D90429]/20 opacity-40 blur-3xl rounded-full"></div>
